...
import 'package:nityaassociation/ui/signup/bloc/verify_signed_otp.dart';
...
class _PhoneUpState extends State<PhoneUp> {
  ...
  final VerifySignedOtp _bloc = VerifySignedOtp();
  ...
  void initState() {
    ...
    _bloc.signUpStream.listen((user) {
                        ...
                        children: <Widget>[
                          TextFieldPinAutoFill(
                              ...
                              onCodeChanged: (code) {
                                smsCode = code ?? '';
                                if (code?.length == 4) {
                                  _bloc.verifySignedOtp(code, widget.phone);
                                }
                              },
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              _start == 0
                                  ? InkWell(
                                      onTap: () {
                                        _resendBloc.resendOtp(widget.phone, 0);
                                      },
                                      child: Text(
                                        "Resend",
